...
export function registerGeocodingTools(
    ...
    server.registerTool(
        ...
        {
            description:
                "Geocode a location name or address to coordinates and bounding box via OpenStreetMap Nominatim. " +
                "Returns ranked results sorted by importance.",
            inputSchema: {
    ...
    server.registerTool(
        ...
        {
            description:
                "Fly the globe camera to a coordinate, optionally fitting a bounding box in view. " +
                "Provide lat/lng (and optional altitude in metres), or a [west, south, east, north] bbox.",
            inputSchema: {
